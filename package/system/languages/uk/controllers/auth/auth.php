<?php
    ...
    define('LANG_RULE_AUTH_VIEW_CLOSED',        'Доступ до відключеного сайту');
    ...
    define('LANG_REG_CFG_AUTH_REDIRECT_PROFILE',     'Відкрити профіль');
    define('LANG_REG_CFG_AUTH_REDIRECT_PROFILEEDIT', 'Відкрити налаштування профілю');
    ...
    define('LANG_REG_CFG_REG_AUTO_AUTH',        'Авторизувати користувача зразу після реєстрації на сайті');
    ...
    define('LANG_REG_SUCCESS_VERIFIED_AND_AUTH', 'Адреса e-mail успішно підтверджена. Ласкаво просимо!');

    define('LANG_VERIFY_EMAIL_ERROR',        'Користувача з таким кодом підтвердження немає, можливо акаунт уже активований або вийшов час активації');
    define('LANG_VERIFY_EMAIL_CODE',         'Код підтвердження реєстрації');
    define('LANG_PROCESS_VERIFY_EMAIL',      'Підтвердження реєстрації');
    define('LANG_RESTORE_TOKEN_EXPIRED',     'Запит на відновлення паролю сплив');
    define('LANG_RESTORE_TOKEN_IS_SEND',     'Інструкція по відновленню пароля уже була відправлена, перевірте папку "Спам"');
    define('LANG_RESTORE_BLOCK',             'Акаунт заблокований');
