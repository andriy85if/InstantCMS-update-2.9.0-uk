<?php
    ...
    define('LANG_CONTENT_RETURN_CONFIRM',    'Ви впевнені, що хочете відкликати цей допис з перевірки?\nВін переміститься в ваші чернетки.');
    define('LANG_CONTENT_SAVE_DRAFT',		 'Зберегти в чернетки');
    define('LANG_CONTENT_MOVE_DRAFT',		 'Перемістити в чернетки');
    define('LANG_CONTENT_DRAFT_NOTICE',		 'Допис прихований в чернетки');
    define('LANG_CONTENT_DRAFT_LIST',		 'Чернетки');
    define('LANG_CONTENT_EDITED',            'Відредаговано');
    ...
    define('LANG_LOGIN_ADMIN_ONLY',          'Ви не можете увійти на відключений сайт');
    ...
    define('LANG_MODERATION_USERS',          'Ваші матеріали, які очікують на перевірку');
    define('LANG_MODERATOR',                 'Модератор');
    define('LANG_MODERATORS',                'Модератори');
    define('LANG_MODERATION_SUCCESS',        'Перевірено');
    define('LANG_MODERATION_APPROVE',        'Схвалити допис');
    define('LANG_MODERATION_RETURN',         'Відкликати з перевірки');
    define('LANG_MODERATION_RETURN_FOR_REVISION', 'Повернути на доопрацювання');
    define('LANG_MODERATION_REFUSE',         'Відхилити та видалити %s');
    define('LANG_MODERATION_REFUSE_REASON',  'Вкажіть причину відхилення');
    define('LANG_MODERATION_REMARKS',        'Зауваження');
    ...
    define('LANG_MODERATION_SEND',           'Надіслати на модерацію');
    define('LANG_MODERATION_NOTICE',         'Буде опубліковано після перевірки модератором. ');
    define('LANG_MODERATION_NOTICE_MODER',   'Допис очікує вашого схвалення. ');
    define('LANG_MODERATION_NOTICE_VIEW',    '%s %s вже %s його%s, рішення ще не прийняте.');
    define('LANG_MODERATION_VIEW',           'переглядав');
    define('LANG_MODERATION_VIEWS',          'переглядали');
    ...
    define('LANG_MODERATION_RETURN_NOTIFY',  'Автор відкликав матеріал з перевірки');
    define('LANG_MODERATION_REMARK_NOTIFY',  'Допис повернено на доопрацювання');
    define('LANG_PM_MODERATION_COMMENT_APPROVED', 'Модератор схвалив розміщення коментаря на сторінці <b><a href="%2$s">%1$s</a></b>%3$s');
    define('LANG_PM_MODERATION_APPROVED',    'Модератор схвалив розміщення сторінки <b><a href="%2$s">%1$s</a></b>%3$s');
    ...
    define('LANG_PERM_OPTION_YES',           'Так');
    define('LANG_PERM_OPTION_PREMOD',        'З премодерацією');
    define('LANG_PERM_OPTION_PREMOD_OWN',    'Тільки свої з премодерацією');
    define('LANG_PERM_OPTION_PREMOD_ALL',    'Всі з премодерацією');
    define('LANG_PERM_OPTION_OWN',           'Тільки свої');
    define('LANG_PERM_OPTION_OTHER',         'Тільки чужі');
    ...
    define('ERR_USER_NOT_FOUND',             'Такого користувача не існує');
    ...
    define('LANG_PUBLISH',					 'Опублікувати');
    ...
    define('LANG_ICONS_BY_FATCOW',           'Іконки від <a href="https://ru.icons8.com/">Icons8</a>');
